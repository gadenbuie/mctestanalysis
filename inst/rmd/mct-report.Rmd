...
Within the contents of this report, you will find graphical representations such as plots, graphs, and tables all intended to validate the three claims proposed in Jorion’s paper.
...
gridExtra::grid.arrange(
  ...
  decorate(discriminationDifficultyPlot(mctd, "conventional", show_gridlines = FALSE)),
  decorate(discriminationDifficultyPlot(mctd, "pbcc", show_gridlines = FALSE)),
  decorate(discriminationDifficultyPlot(mctd, "pbcc_modified", show_gridlines = FALSE)),
  ncol = 2
)
```
